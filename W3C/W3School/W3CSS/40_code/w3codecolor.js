...
function w3CodeColor() {
  ...
  function w3CodeColorize(x, lang) {
    ...
    function kotlinMode(txt) {
      ...
      return "<span style=color:" + kotlincolor + ">" + rest + "</span>";
    }
    function kotlinStringMode(txt) {
      return "<span style=color:" + kotlinstringcolor + ">" + txt + "</span>";
    }
    function kotlinKeywordMode(txt) {
      return "<span style=color:" + kotlinkeywordcolor + ">" + txt + "</span>";
    }
    function kotlinNumberMode(txt) {
      return "<span style=color:" + kotlinnumbercolor + ">" + txt + "</span>";
    }
    function kotlinPropertyMode(txt) {
      return "<span style=color:" + kotlinpropertycolor + ">" + txt + "</span>";
    }
